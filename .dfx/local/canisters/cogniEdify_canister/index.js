...
import { idlFactory } from './cogniEdify_canister.did.js';
export { idlFactory } from './cogniEdify_canister.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_COGNIEDIFY_CANISTER;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./cogniEdify_canister.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the cogniEdify_canister canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./cogniEdify_canister.did.js")._SERVICE>}
 */
export const cogniEdify_canister = createActor(canisterId);
